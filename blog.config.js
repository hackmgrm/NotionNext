...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '4ba5541cd1994796856d2e3fcedf516d',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '空运新视角', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '混迹货代圈的互联网人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://aircargo.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '空运新视角, 海运，货代，外贸，上海空运，空运', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'admin@migroom.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'http://weibo.com/7104322', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'http://twitter.com/etoeasy', // 你的twitter个人主页
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '皖ICP备09010983号-3', // 备案号 闽ICP备XXXXXXX
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo-zeabur.aircargo.ren', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '1c9b6258f5f6ae4fb4a7aaaefee101a5', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-NRPBV7XWNG', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
